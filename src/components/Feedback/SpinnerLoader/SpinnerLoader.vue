...
<template>
    <div class="base-loader-wrapper" :style="style">
        <div :class="`base-loader-body ${finished ? 'finished' : ''}`"></div>
        <div :class="`base-loader-finished ${finished ? 'finished' : ''}`">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                viewBox="-7.84 -7.84 94.05 94.05" xml:space="preserve" stroke="white" stroke-width="0.0007836900000000001"
                transform="matrix(1, 0, 0, 1, 0, 0)rotate(0)">
                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="white"
                    stroke-width="0.156738"></g>
        ...
        <div class="base-loader-label" v-if="label && !finished">
            <small>{{ label }}</small>
        </div>
    </div>
</template>
