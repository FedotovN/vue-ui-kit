...
import BaseFileInputProps from "@/types/props/Forms/FileInputProps";
...
const emits = defineEmits<{
    (e: 'input', value: typeof file.value)
}>();
function onFileInput(e: Event) {
    if (props.disabled) return;
    file.value = getFileFromInput(e, props.multiple);
    console.log(file.value);

    emits('input', file.value);
}
...
<template>
    <div class="base-file-input-wrapper" :class="{ disabled }" @click="fileInput?.click()" :style="style">
        <div class="base-file-input">
            <svg fill="#000000" height="200px" width="200px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 490.955 490.955" xml:space="preserve">
        ...
        <input type="file" style="display: none;" @input="onFileInput" ref="fileInput" :accept="acceptMime"
            :multiple="multiple" />
    </div>
</template>
