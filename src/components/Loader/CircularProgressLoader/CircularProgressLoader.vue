<script setup lang="ts">
    ...
    const clampedValue = computed(() => {
        ...
        return percentage > 100 ? 100 : percentage < props.min ? props.min : percentage;
    });
...
<template>
    <div class="circular-progress-loader-wrapper" :style="style">
        ...
        <svg class="circular-progress-loader" viewBox="0 0 120 120" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <circle class="circular-progress-loader-path" cx="60" cy="60" r="50"/>
            <circle :class="`${props.rounded ? 'rounded' : ''}`" class="circular-progress-loader-fill" cx="60" cy="60" r="50"></circle>
        </svg>
    </div>
</template>
