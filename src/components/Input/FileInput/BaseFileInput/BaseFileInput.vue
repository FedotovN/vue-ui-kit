<script setup lang="ts">
    ...
    const emits = defineEmits<{
        (e: 'input', value: FileDisplay)
    }>();
    function onFileInput(e: Event) {
        file.value = getFileFromInput(e);
        emits('input', file.value);
    }
</script>
<template>
    <div class="base-file-input-wrapper" @click="fileInput?.click()">
        ...
        <input type="file" style="display: none;" @input="onFileInput" ref="fileInput" />
    </div>
</template>
